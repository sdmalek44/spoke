...
describe "A registered user visits 'trip-dashboard'" do
  before :each do
    ...
    @trip_4 = Trip.create!(duration: 40, start_date: Date.new(2000, 2, 4), end_date: Date.new(2000, 2, 4), start_station_id: @station_2.id, end_station_id: @station_1.id, bike_id: 1, subscription_type: 1, zip_code: 68686)
    @trip_5 = Trip.create!(duration: 50, start_date: Date.new(2001, 2, 4), end_date: Date.new(2001, 2, 4), start_station_id: @station_2.id, end_station_id: @station_1.id, bike_id: 2, subscription_type: 1, zip_code: 68686)
    @trip_6 = Trip.create!(duration: 60, start_date: Date.new(2002, 5, 4), end_date: Date.new(2002, 5, 4), start_station_id: @station_3.id, end_station_id: @station_4.id, bike_id: 2, subscription_type: 1, zip_code: 68686)
  ...
  it 'they see information about most visited stations' do
    visit trips_dashboard_path
